...
export default function Horario() {
  return (
    <div>
      ...
      <div className="seleccion otro-seleccion">
        {Array(10)
          .fill(0)
          .map((_, i) => (
            <div className="carta decarta" key={i}>
              <p>May</p>
              <p>{i}</p>
            </div>
          ))}
      ...
      <div>
        <h2>Seleccione un formato</h2>
        <div className="seleccion">
          <div className="carta otra-carta">
        ...
        <div className="pelculas-horarios">
          {Object.values(movies).map((movie) => (
            <div className="tarjeta-pelicula" key={movie.id}>
              <img
                className="peli-info-poster"
                src={movie.poster}
                alt={movie.title}
              />
              <div className="info-peliculas">
                <div className="uno-info">
                  <p className="dosd">2D</p>
                  <p>
                  ...
                  <p>
                    Clasificacion:
                    <strong className="mayores">Mayores de 14 años</strong>
                  </p>
                </div>
