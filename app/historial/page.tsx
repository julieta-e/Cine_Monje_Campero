...
export default function Historial() {
  return (
    <div className="historial-container">
      <h2 className="historial-titulo">Historial de Películas</h2>
      <div className="lista-peliculas-historial">
        {movies.map((pelicula) => {
          const trailerId = pelicula.trailerLink.split("v=")[1];
          return (
            ...
            <div key={pelicula.id} className="pelicula-card">
              ...
              />
              <h3 className="pelicula-titulo">{pelicula.title}</h3>
            </div>
          );
        })}
      </div>
